...
describe('Blog post tests', () => {
  ...
  // 5.15, should be refactored
  test.skip('event handler should be called twice when like button is clicked twice', () => {
    const button = component.getByText('like')
    fireEvent.click(button)
    fireEvent.click(button)
    
    const div = component.container.querySelector('.likesInfo')
    console.log(div)
